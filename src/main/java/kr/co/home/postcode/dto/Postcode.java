package kr.co.home.postcode.dto;
...
public class Postcode {
	...
	public String toString() {
		return String.format("Postcode [zipcode=%s, sido=%s, sigungu=%s, doro=%s, building1=%s, building2=%s]", zipcode,
				sido, sigungu, doro, building1, building2);
	}
	public String[] toArray(){
		
		
		return new String[]{zipcode,sido+" "+doro+" "+building1+(building2==0?"":"-"+building2)}; 
	}
